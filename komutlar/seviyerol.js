...
let link = `[Destek Sunucusu!](https://discord.gg/b9NXRN39HM)`
...
.addField(`Ayarlanan Rolleri Görmek:`, `\`${p}seviyerolleri\``)) 
      ...
      if(isNaN(args[1])) return message.channel.send(`<a:atlantis_carpi:776057180612722699> Seviye bir sayı olmalı!`)
