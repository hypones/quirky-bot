...
message.guild.roles.create({ data: { name: '🎤・Şarkıcı' }, reason: 'ayn' }).then(s => s.setColor('#955aab'))
message.guild.roles.create({ data: { name: '🤯・Beyin Yoran' }, reason: 'ayn' }).then(s => s.setColor('#ffff00'))
message.guild.roles.create({ data: { name: '🍽️・Aç' }, reason: 'ayn' }).then(s => s.setColor('#2e9afe'))
message.guild.roles.create({ data: { name: '・・・・・・・・' }, reason: 'ayn' }).then(s => s.setColor('#ffffff'))
...
message.guild.roles.create({ data: { name: '🌈 | LGBT' }, reason: 'ayn' }).then(s => s.setColor('#ffff00'))

message.guild.channels.create('●▬▬๑「Kayıt Alanı」๑▬▬●', {type: 'category'}).then(parent => {
message.guild.channels.create('・registery-chat', {type: 'text'}).then(c => c.setParent(parent.id));
...
message.guild.channels.create('🆙・level-up', {type: 'text'}).then(c => c.setParent(parent.id));
});
...
message.guild.channels.create('🏆・Kurucu Odası', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(10));
  ...
  message.guild.channels.create('♢▬▬▬「Yetkili Alım」▬▬▬♢', {type: 'category'}).then(parent => {
message.guild.channels.create('📌・şartlar', {type: 'text'}).then(c => c.setParent(parent.id));
message.guild.channels.create('🏆・Başvuru', {type: 'text'}).then(c => c.setParent(parent.id));
message.guild.channels.create('🏆・Mülakat', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(10));
...
message.guild.channels.create('🎤 ・ Konser Odası', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(15));
message.guild.channels.create('🔓 ・ Takılma Odası', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(10));
message.guild.channels.create('💫・ Disko Odası', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(10));
});
  
  
  message.guild.channels.create('●▬▬▬▬๑「Private」๑▬▬▬▬●', {type: 'category'}).then(parent => {
message.guild.channels.create('🌙・ Private 1', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(2));
message.guild.channels.create('🌙・ Private 2', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(2));
message.guild.channels.create('🌙・ Private 3', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(2));
message.guild.channels.create('🌙・ Private 4', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(2));
message.guild.channels.create('🌙・ Private 5', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(2));
message.guild.channels.create('🌙・ Private 6', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(2));
message.guild.channels.create('🌙・ Private 7', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(2));
message.guild.channels.create('🌙・ Private 8', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(2));
message.guild.channels.create('🌙・ Private 9', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(3));
message.guild.channels.create('🌙・ Private 10', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(4));
message.guild.channels.create('🌙・ Private 11', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(4));
message.guild.channels.create('🌙・ Private 12', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(5));
...
message.guild.channels.create('🎮・Gamers 1', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(15));
message.guild.channels.create('🎮・Gamers 2', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(15));
message.guild.channels.create('🎮・Gamers 3', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(10));
message.guild.channels.create('🎮・Gamers 4', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(10));
