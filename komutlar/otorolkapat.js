...
if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`<a:atlantis_carpi:776057180612722699> **Bu komutu kullanabilmek için** "\`Yönetici\`" **yetkisine sahip olmalısın.**`);
 ...
 if(!rol) return message.reply(`<a:atlantis_carpi:776057180612722699> **Bu özellik zaten kapalı! **`)
 
 
  message.channel.send(`<a:yesil_dogrulama:771039259330084885>  **Otorol Sistemi başarılı bir şekilde kapatıldı.**`)
