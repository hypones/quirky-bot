...
if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`<a:atlantis_carpi:776057180612722699>  **Bu komutu kullanabilmek için** "\`Yönetici\`" **yetkisine sahip olmalısın.**`);
 ...
 if(isNaN(args[1])) return message.channel.send(`<a:atlantis_carpi:776057180612722699>   **Belirttiğin Sayı Çok Küçük Veya O Sayıya Zaten Ulaşmışsın!**\n**__Örnek Kullanım__** : \`${prefix}sayaç-ayarla #kanal <Sayı>\``)
 
 if(message.guild.memberCount > args[1]) return message.channel.send(`<a:atlantis_carpi:776057180612722699>  **Belirttiğin Sayı Çok Küçük Veya O Sayıya Zaten Ulaşmışsın!**\n**__Örnek Kullanım__** : \`${prefix}sayaç-ayarla #kanal <Sayı>\``)

 
  message.channel.send(`╔▬▬▬▬▬▬▬▬Quirky Sayaç▬▬▬▬▬▬▬▬▬
...
║► <a:hg:752305081545916438> ${args[1]} Kişi Olmaya Son <a:quirky_alevv:787937467176583189> **${kalan}** <a:quirky_alevv:787937467176583189> Kişi Kaldı!
╚▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬`)
