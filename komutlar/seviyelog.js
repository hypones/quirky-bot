...
.setDescription(`<a:atlantis_carpi:776057180612722699> Bu Komutu Kullanmak İçin; \`ADMINISTRATOR\` Yetkisine Sahip Olmalısın!`))
   ...
   if(args[0] == "sıfırla") {
    ...
    return message.channel.send(`<a:yesil_dogrulama:771039259330084885> Seviye-Log sıfırlandı!`);
   ...
   if (args[0]) {
      ...
      message.channel.send(`<a:yesil_dogrulama:771039259330084885> Seviye Log Kanalı Ayarlandı! Ayarlanan Kanal: <#${akanal.id}> Sıfırlamak için .seviye-log sıfırla `)           
